...
public class ModelCruiserTatsuta<T extends EntityShipBase> extends ShipModelHumanoidBase<T> {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        ...
        if (GlowBodyMain != null) {
            ...
            GlowBodyMain2.render(poseStack, vertexConsumer, net.minecraft.client.renderer.LightTexture.FULL_BRIGHT, packedOverlay, 0xFFFFFFFF);
        }
