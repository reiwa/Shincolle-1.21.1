...
public class ParticleShine extends TextureSheetParticle {
    private final SpriteSet sprites;
    private final float initAlpha;

    protected ParticleShine(ClientLevel level, double x, double y, double z,
        ...
        this.yd = Math.abs(ySpeed + Math.cos(phi) * radius);
        this.zd = zSpeed + Math.sin(phi) * Math.sin(theta) * radius;

        this.quadSize = (this.random.nextFloat() * 0.5F + 0.5F) * 0.063F;
        this.lifetime = (int) (this.random.nextDouble() * 20.0D) + 40;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new ParticleShine(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites);
        }
    }
}
