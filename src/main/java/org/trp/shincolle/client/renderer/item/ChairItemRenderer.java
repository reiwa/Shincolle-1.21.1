...
public class ChairItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private final ModelBlockChair model;

    public ChairItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
        super(dispatcher, modelSet);
        this.model = new ModelBlockChair(modelSet.bakeLayer(ModelBlockChair.LAYER_LOCATION));
    }
